...
resource "aws_autoscaling_group" "asg_blue" {
  count = (var.deployment_strategy == "blue-green" && var.active_asg == "blue") || (var.deployment_strategy == "single" && var.active_asg == "blue") ? 1 : 0
...
resource "aws_autoscaling_group" "asg_green" {
  count = (var.deployment_strategy == "blue-green" && var.active_asg == "green") || (var.deployment_strategy == "single" && var.active_asg == "green") ? 1 : 0
